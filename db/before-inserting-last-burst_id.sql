...
CREATE TABLE `burst` (
  ...
  `run_number` bigint(20) DEFAULT NULL,
  `globalnumber` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `globalnumber_UNIQUE` (`globalnumber`),
...
CREATE TABLE `file` (
  ...
  KEY `fk_file_burst1_idx` (`burst_id`),
  CONSTRAINT `fk_file_burst1` FOREIGN KEY (`burst_id`) REFERENCES `burst` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2014-07-30 12:16:17
