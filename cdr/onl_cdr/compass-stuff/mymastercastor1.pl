...
# $Id: mymaster.pl,v 1.2 2006/02/02 17:37:45 neyret Exp $
...
my $user="objsrvvy";
my $logdir = "/tmp/ccf"; # default value, can be changed below ..
...
push @{$controlhash{2}},"onl_cdr/submitStage0_castor1.pl",1;
